// Copyright (c) 2018 RupeeEvolution developers
...
const uint32_t MIN_RING_SIZE = 5; // Minimum Ring Signature Size, Recommended at least 5 - R u p e e E v o l u t i o n
