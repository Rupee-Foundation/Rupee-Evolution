// Copyright (c) 2014 The RupeeEvolution developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("rupeeevolution-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("rupeeevolution-smsg-pow"); // Make this thread recognisable
