...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (123.45.68.69:64639)");
        msg.exec();
        return;
    }
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter the transaction hash for the transaction that has 8400 RUPEE");
        msg.exec();
        return;
    }
