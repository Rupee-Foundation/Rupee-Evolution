    ...
    address(addr)
{
    ...
    if (label.trimmed().isEmpty()) {
        setWindowTitle(QString("RupeeEvolution - Generate QR Code"));
    } else {
        setWindowTitle(QString("RupeeEvolution - Generate QR Code for %1").arg(label));
    }
...
{
    QString ret = QString("rupeeevolution:%1").arg(address);
    int paramCount = 0;
