...
const QString kBaseUrl = "http://rupeeevolution.io/dnrusd.php";
const QString kBaseUrl1 = "http://rupeeevolution.io/dbitcoin.php";
const QString kBaseUrl2 = "http://rupeeevolution.io/dnrmc.php";
const QString kBaseUrl3 = "http://rupeeevolution.io/dnrbtc.php";

QString bitcoinp = "";
QString rupeeevolutionp = "";
QString dnrmcp = "";
QString dnrbtcp = "";
double bitcoin2;
double rupeeevolution2;
double dnrmc2;
double dnrbtc2;
QString bitcoing;
QString dnrnewsfeed;
...
if (what == kBaseUrl) // RupeeEvolution Price
{

    // QNetworkReply is a QIODevice. So we read from it just like it was a file
    QString rupeeevolution = finished->readAll();
    rupeeevolution2 = (rupeeevolution.toDouble());
    rupeeevolution = QString::number(rupeeevolution2, 'f', 2);
	
    if(rupeeevolution > rupeeevolutionp)
    {
        ui->rupeeevolution->setText("<font color=\"yellow\">$" + rupeeevolution + "</font>");
    } else if (rupeeevolution < rupeeevolutionp) {
        ui->rupeeevolution->setText("<font color=\"red\">$" + rupeeevolution + "</font>");
        } else {
    ui->rupeeevolution->setText("$"+rupeeevolution+" USD");
    }

    rupeeevolutionp = rupeeevolution;
...
if (what == kBaseUrl2) // RupeeEvolution Market Cap
{
...
if (what == kBaseUrl3) // RupeeEvolution BTC Price
{
