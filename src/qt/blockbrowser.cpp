...
{
    if(Height > pindexBest->nHeight) { return "00000d95779742dfa06ba61b0b567b9942da774a4354bc86625cd001fb573cd1"; }
    if(Height < 0) { return "00000d95779742dfa06ba61b0b567b9942da774a4354bc86625cd001fb573cd1"; }
    int desiredheight;
...
void BlockBrowser::updateExplorer(bool block)
{
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " RUPEE");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " RUPEE");
    }
}
