...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. RupeeEvolution can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    app.setOrganizationName("RupeeEvolution");
    //XXX app.setOrganizationDomain("");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("RupeeEvolution-Qt-testnet");
    else
        app.setApplicationName("RupeeEvolution-Qt");
    ...
    {
        QMessageBox::critical(0, "RupeeEvolution",
    ...
    try
    {
        ...
        if(AppInit2())
        {
            ...
            splash.show();
            splashref = &splash;
            uiInterface.InitMessage(_("RupeeEvolution is shutting down, please do not turn off your computer..."));
