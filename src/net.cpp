...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("rupeeevolution-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("rupeeevolution-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("rupeeevolution-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RupeeEvolution " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    ...
    {"seed.rupeeevolution.host", "seed.rupeeevolution.host"},
    {"seed.rupeeevolutionexplorer.org", "seed.rupeeevolutionexplorer.org"},
    {"seed.yiimp.eu", "seed.yiimp.eu"},
    {"chainz.cryptoid.info", "chainz.cryptoid.info"},
    {"rupeeevolution.host", "rupeeevolution.host"}
};
...
void ThreadDNSAddressSeed(void* parg)
{
    if(!fNativeTor)
    {
        ...
        RenameThread("rupeeevolution-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("rupeeevolution-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("rupeeevolution-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("rupeeevolution-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RupeeEvolution is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("rupeeevolution-start");
