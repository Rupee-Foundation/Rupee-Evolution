...
Value fortunastake(const Array& params, bool fHelp)
{
    ...
    if (fHelp  ||
		...
		throw runtime_error(
			...
			"  start        - Start fortunastake configured in rupeeevolution.conf\n"
			...
			"  stop         - Stop fortunastake configured in rupeeevolution.conf\n"
			...
			//"  vote-many    - Vote on a RupeeEvolution initiative\n"
			//"  vote         - Vote on a RupeeEvolution initiative\n"
            );
    if (strCommand == "stop")
    {
